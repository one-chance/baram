...
// NOTE update post
videoSchema.statics.updateBySeq = function (seq, post) {
...
// NOTE delete post
videoSchema.statics.deleteBySeq = function (seq, post) {
  return this.deleteOne({ seq: seq });
};

// NOTE add viewCount
videoSchema.statics.addViewCount = function (seq) {
  return this.findOneAndUpdate(
    {
      seq: seq,
    },
...
// NOTE recommend
videoSchema.statics.pushRecommendUser = function (seq, userid) {
  return this.findOneAndUpdate(
    {
      seq: seq,
    },
...
// NOTE unRecommend
videoSchema.statics.popRecommendUser = function (seq, userid) {
  return this.findOneAndUpdate(
    {
      seq: seq,
    },
...
videoSchema.statics.findCountByFilter = function (filter) {
...
// NOTE Get by seq
videoSchema.statics.findOneBySeq = function (seq) {
  return this.findOne({ seq: seq });
};

// NOTE Push Comment
videoSchema.statics.createComment = function (postSeq, comment) {
  return this.findOneAndUpdate(
    {
      seq: postSeq,
    },
...
// NOTE Update Comment
videoSchema.statics.updateComment = function (postSeq, comment) {
  return this.findOneAndUpdate(
    {
      seq: postSeq,
      commentList: {
...
// NOTE Delete Comment
videoSchema.statics.deleteComment = function (postSeq, commentIdx) {
  return this.findOneAndUpdate(
    {
      seq: postSeq,
      commentList: {
...
// NOTE Push Recomment
videoSchema.statics.createRecomment = function (postSeq, commentIdx, recomment) {
  return this.findOne(
    {
      seq: postSeq,
      commentList: {
...
videoSchema.statics.updateRecomment = function (postSeq, commentIdx, recomment) {
  return this.findOne(
    {
      seq: postSeq,
      commentList: {
...
videoSchema.statics.deleteRecomment = function (postSeq, commentIdx, recomment) {
  return this.findOne(
    {
      seq: postSeq,
      commentList: {
...
module.exports = mongoose.model("Video", videoSchema, "videoBoard");

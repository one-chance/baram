    ...
    <React.Fragment>
      <Box>
        <Grid container spacing={0} direction="row" justify="center" className={classes.menuTabs}>
                ...
                <List>
                  ...
                  {(isOpen || isOpenFixed) &&
                    menu.sub.map((submenu: IMenu) => (
                      ...
                      >
                        <Typography align="center" variant="subtitle2" display="block">
                          {submenu.title}
                        </Typography>
                      </ListItem>
                    ))}
          ...
          <Grid item sm={1} className={classes.menuTab}>
            {isOpenFixed ? (
              <IconButton onClick={_onListItemClose}>
                <ExpandLessIcon />
              </IconButton>
            ) : (
              <IconButton onClick={_onListItemOpen}>
                <ExpandMoreIcon />
              </IconButton>
            )}
          </Grid>
